...
import com.streambus.commonmodule.table.HistoryStatusInfoDao;
...
public class MigrationHelper {
    ...
    public void migrateDb(Database db) {
        generateTempTables(db, VodFavChannelInfoDao.class);
        VodFavChannelInfoDao.dropTable(db, true);
        VodFavChannelInfoDao.createTable(db, true);
        restoreData(db, VodFavChannelInfoDao.class);
    }
