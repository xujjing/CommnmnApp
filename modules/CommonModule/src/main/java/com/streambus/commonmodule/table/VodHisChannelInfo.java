 ...
 */
@Entity
public class VodHisChannelInfo implements IVodChannelInfo{
    @Id
    ...
    @Generated(hash = 783024362)
    public VodHisChannelInfo(Long id, @NotNull String channelJson,
            Long updateTime) {
        this.id = id;
    ...
    @Generated(hash = 730885019)
    public VodHisChannelInfo() {
    }
