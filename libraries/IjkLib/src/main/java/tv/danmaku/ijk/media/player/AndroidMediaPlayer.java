...
public class AndroidMediaPlayer extends tv.danmaku.ijk.media.widget.media.AbstractMediaPlayer {
    ...
    public long getCurrentPosition() {
        try {
            ...
            DebugLog.w(TAG,"getCurrentPosition", e);
            return 0;
        }
    }
