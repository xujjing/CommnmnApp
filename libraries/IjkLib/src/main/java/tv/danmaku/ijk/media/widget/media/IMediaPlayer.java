...
public interface IMediaPlayer{
    ...
    void setOnRecordingStatusListener(OnRecordingStatusListener listener);

    void setOnRecordingProgressListener(OnRecordingProgressListener listener);

    void setOnPullStreamListener(OnPullStreamListener listener);

    void setOnLineDetectionListener(OnLineDetectionListener lineDetectionListener);
    void setOnNativeInvokeListener(IjkMediaPlayer.OnNativeInvokeListener nativeInvokeListener);
    ...
    interface OnRecordingStatusListener {
        void onRecordingStatus(IMediaPlayer mp, int what, int extra);
    }

    interface OnRecordingProgressListener {
        void OnRecordingProgress(IMediaPlayer mp, int count);
    }

    interface OnPullStreamListener {
        void OnPullStream(IMediaPlayer mp);
    }
     ...
     * 2.最终返回的探测线路
     */
    interface OnLineDetectionListener {
        void OnLineDetection(IMediaPlayer mp, int playId, String optimizeLine);
    }
