...
import tv.danmaku.ijk.media.player.exo.DemoPlayer;
import tv.danmaku.ijk.media.player.exo.EventLogger;
import tv.danmaku.ijk.media.player.exo.ExtractorRendererBuilder;
import tv.danmaku.ijk.media.player.exo.HlsRendererBuilder;
import tv.danmaku.ijk.media.player.exo.SmoothStreamingRendererBuilder;
import tv.danmaku.ijk.media.player.exo.SmoothStreamingTestMediaDrmCallback;
...
public class IjkExoMediaPlayer extends AbstractMediaPlayer {
    ...
    @Override
    public void setOnNativeInvokeListener(IjkMediaPlayer.OnNativeInvokeListener nativeInvokeListener) {
